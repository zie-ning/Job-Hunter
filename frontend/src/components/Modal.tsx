...
export function Modal({ title, onClose, wide = false, children }: ModalProps) {
  ...
  return (
    ...
    <div
      className="modal-overlay animate-fade-in fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 p-6 pt-[10vh] motion-reduce:animate-none"
      onClick={onClose}
    >
      <div
        ref={contentRef}
        ...
        aria-label={title}
        className={[
          "modal-content animate-fade-scale bg-surface shadow-e3 w-full rounded-lg p-6 motion-reduce:animate-none",
